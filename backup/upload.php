...
<br><br>
<div class="container" style="border:1px solid #e9e9e9;max-width:900px;background-color:white;border-radius:6px;">

	<div class="page-header">
	<?if(!$_GET[u]){?>
		<h1>파일 업로드</h1>
		<p>작업한 작품을 업로드 해주세요.</p><br>
	<?}else{?>
		<h1>파일 업데이트</h1>
		<p>현재 작품을 업데이트한 작품을 업로드 해주세요.</p><br>
	<?}?>
	</div>
...
<!--셀렉-->
	...
	<form action="upload_check.php" method=post class="form-inline" role="form" align="strong" enctype="multipart/form-data">
		...
		<center>
			...
			&nbsp;&nbsp;
			<input type="button" class="btn btn-default" value="되돌아가기"
