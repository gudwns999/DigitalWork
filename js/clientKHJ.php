...
/////////////////////////////////////////////////////////////////rating///////////////////////////////////////////////////
$("<div id='cardThread'><input type='hidden' id='mp'/><input type='hidden' id='fp' value='"+e[i].file_no+"' /><img data-toggle='modal' data-target='#detailThread' id='cardImage' src='http://capstone.hae.so/v2/image_view.php?no="+e[i].file_no+"' style='cursor:pointer; border-top-left-radius:5px; border-top-right-radius:5px; border-bottom:1px solid #a9a9a9; max-width:100%; height:auto;' /><div style='margin:6px 3px 0 3px; white-space:normal; font-size:14px; font-weight:500;'><div id = 'cardFileName'>"+e[i].title+"</div><br><span style='color:#aaaaaa; font-size:12px;'> "+e[i].nickname+"</span><br><br><span style='font-size:13px;'>"+e[i].description+"</span><span style='color:#aaaaaa; font-size:12px;'>"+e[i].score+" </span></div></div><br>").insertAfter($(".w3-card-12").eq(p-1).find('#inButton'));
/////////////////////////////////////////////////////////////////rating///////////////////////////////////////////////////
