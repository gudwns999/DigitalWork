...
io.on('connection', function(client)
{
    ...
    client.on('send information',function(id,name,token,room)
    {
        ...
        sql.query("SELECT dg_file_member.nickname, dg_file_list.upload_filename FROM dg_file_list inner join dg_file_member on dg_file_list.file_no = dg_file_member.file_no WHERE dg_file_list.workshop_no= "+room,function(err,rows,fields){
