...
<?include_once("nav.php")?>
 <div class="container-fluid">
	<div class="row content" >
		...
		<div class="row" id="mainArea" style='max-width:900px; margin:0 auto; padding: 6px 6px 6px 6px; background-color:#f9f9f9;'>
		<br>
			<div class="col-sm-8">
				<h2>공방리스트</h2>
				<?
					...
					?>
						<div style="width:100%; border-radius:5px; padding:0 0 0 3px; display: flex; align-items: center; height:90px; background-color:white; border:1px solid #e9e9e9;">
							<div class="row" style="width:100%;">
								...
								<div class="col-sm-8">
									<a href="http://capstone.hae.so:9000/workshop.php?no=<?=$ret[no]?>"><span style="font-size:16px; color:black;"><?=$ret[name]?></span></a>
				...
				<div class="row">
					<div class="col-sm-12">
						<center>
							<br>
							<?if(!$_SESSION[id]){?>
							<a href="http://capstone.hae.so/v2/login.php?go=http://capstone.hae.so/v2/"><span>로그인</span></a><br>
							<?}else{?>
								<?
							...
							?>
							<br>
							<button type="button" class="btn btn-default" style="width:50%;text-align:center;" onclick="location.href='create.php'">공방 만들기</button><br>
							<a href="http://capstone.hae.so/v2/logout.php"><span>로그아웃</span></a><br></center>
					</div>
				</div>
				<?
