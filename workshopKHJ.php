...
<head>
    ...
    <script src="http://capstone.hae.so/v2/js/clientKHJ.php?no=<?=$_GET[no]?>"></script>
...
<div class="modal" id="detailThread">
        ...
        <div class="modal-content" style="width:750px; padding: 12px 12px 12px 12px;">\
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    ...
                    <!--////////////////////////////////rating////////////////////////////////////////////////////////////////////////-->
                    <div class="form-group">
                        <div class="image_rollover" style="width:100%; text-align:center;">별점
                        <span class="star-input" id="star-inputs"><span class="input">
    ...
    <input type="radio" name="star-input" id="p10" value="10" onclick="rating10()"><label for="p10">10</label>
                    ...
                    <!--////////////////////////////////rating////////////////////////////////////////////////////////////////////////-->
                    <div class="form-group">
                        <button id="ratingBtn" onclick="location.href='invite.php'" type="button" class="btn btn-default" data-dismiss="modal" style="width:100%; text-align:center;">투표</button>
                    </div>
                    <div class="form-group">
...
<div id="dialog" style="z-index:2000;">
    <hr><input type="text" name="search" id="search" placeholder="Search members">
</div>
